...
export type KbdProps = ComponentProps<"span"> & { separator?: ReactNode };
export const Kbd = ({
  className,
  ...
  <span
    className={cn(
      "inline-flex select-none items-center gap-1 rounded-sm border bg-muted px-1.5 align-middle font-medium font-mono text-[10px] text-muted-foreground leading-loose",
      className
    )}
    {...props}
  >
